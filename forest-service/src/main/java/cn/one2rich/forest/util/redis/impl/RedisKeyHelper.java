...
public class RedisKeyHelper {
  ...
  public static final String TC_TRANS_CURRENT_DEAL_CONFIG_PREFIX =
      TC_PREFIX + "CURRENT_DEAL_CONFIG_";

  public static final String TC_TRANS_EXPERIENCE_MONEY_CONFIG_PREFIX =
      TC_PREFIX + "EXPERIENCE_MONEY_CONFIG_";

  public static final String TC_TRANS_CURRENT_DEAL_LOAD_PREFIX = TC_PREFIX + "CURRENT_DEAL_LOAD_";

  public static final String TC_TRANS_CONST_DEAL_ORDER_LIST_PREFIX =
      TC_PREFIX + "CURRENT_CONST_DEAL_ORDER_LIST_";
